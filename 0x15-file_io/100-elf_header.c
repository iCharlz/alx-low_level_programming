...
* @e_ident: Point to the array containing the ELF magic numb.
*
...
/**
* print_magic - Print the magic numb of ELF header.
* @e_ident: Point to an array containing ELF magic numb.
*
...
* @e_ident: Point to the array containing ELF class.
*/
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
...
*   * @e_ident: Point to the array containing ELF version.
*    */
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
...
* @e_ident: Point to the array containing the ELF ABI version.
*/
void print_abi(unsigned char *e_ident)
{
